...
<body>
    ...
    <form action="login.php" method="post">
        ...
        <div class="firstinput">
            ...
            <span class="link2">
               <a href="index_number.php">Phone Number</a>
            </span>
        </div>
        <br>
       <input type="email" id="myInput" name="username" placeholder="Email address" required> <br><br>
       <input type="password" id="myInput" name="password" placeholder="Password" required><br>
       ...
       <p id="thirdp">Not register yet? <a href="register_email.php"><span style="font-weight: bold;">Create Account </span></a></p> 
    </form>
</body>
</html>